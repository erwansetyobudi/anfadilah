...
<script>
  $('.c-header, .vegas-slide').vegas({
        ...
        slides: [
            ...
            { src: "<?php echo CURRENT_TEMPLATE_DIR . v('assets/images/slide5.jpg'); ?>" },
            { src: "<?php echo CURRENT_TEMPLATE_DIR . v('assets/images/slide6.jpg'); ?>" },
            { src: "<?php echo CURRENT_TEMPLATE_DIR . v('assets/images/slide7.jpg'); ?>" },
            { src: "<?php echo CURRENT_TEMPLATE_DIR . v('assets/images/slide8.jpg'); ?>" },
            { src: "<?php echo CURRENT_TEMPLATE_DIR . v('assets/images/slide9.jpg'); ?>" }
        ]
    });
</script>
<?php
