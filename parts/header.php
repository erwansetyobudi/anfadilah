...
<!-- Default Blue Template by Erwan Setyo Budi -->
<?php
...
<head>
    ...
    <?php else : ?>
        <meta property="og:image" content="//<?php echo $_SERVER["SERVER_NAME"] . SWB . $sysconf['template']['dir']; ?>/default-blue/img/logo.svg" />
    <?php endif; ?>
    ...
    <?php else : ?>
        <meta property="twitter:image" content="//<?php echo $_SERVER["SERVER_NAME"] . SWB . $sysconf['template']['dir']; ?>/default-blue/img/logo.svg" />
    <?php endif; ?>
    ...
    <link rel="stylesheet" href="<?php echo assets('css/anfadilah.css?v=' . date('Ymd-his')); ?>">
